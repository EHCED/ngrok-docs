...
| `to`          | string                    | A regular expression string to replace the `from` match with. Also contains [cel expressions](https://ngrok.com/docs/http/traffic-policy/expressions/) outside of regular regex. |
